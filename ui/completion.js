...
const BUILTINS = [
  ...
  { name: "diff", sig: "diff(expr, X)", doc: "symbolic derivative ∂expr/∂X — X must be a declared tensor variable" },
  ...
  { name: "ddot", sig: "ddot(A, B)", doc: "double contraction A : B — a scalar" },
